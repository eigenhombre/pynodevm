...
TARBALL_URL="https://warehouse.meteor.com/bootstrap/0.6.5/meteor-bootstrap-${PLATFORM}.tar.gz"
...
echo
echo "Meteor 0.6.5 has been installed in your home directory (~/.meteor)."
